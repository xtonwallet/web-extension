...
class PaymentChannel extends Contract {
  ...
  /**
     ...
     * @param options   {{isA: boolean, channelId: BigNumber, myKeyPair: nacl.SignKeyPair, hisPublicKey: Uint8Array, initBalanceA: BigNumber, initBalanceB: BigNumber, addressA: Address, addressB: Address, closingConfig?: {quarantineDuration: number, misbehaviorFine: BigNumber, conditionalCloseDuration: number}, excessFee?: BigNumber}}
     */
  ...
  /**
     * @param params    {{balanceA: BigNumber, balanceB: BigNumber}}
     * @returns {Promise<{cell: Cell, signature: Uint8Array}>}
     */
  ...
  /**
     * @param params    {{hisSignature?: Uint8Array, balanceA: BigNumber, balanceB: BigNumber, seqnoA: BigNumber, seqnoB: BigNumber}}
     * @returns {Promise<{cell: Cell, signature: Uint8Array}>}
     */
  ...
  /**
     * @param params    {{hisSignature?: Uint8Array, seqnoA: BigNumber, seqnoB: BigNumber}}
     * @returns {Promise<{cell: Cell, signature: Uint8Array}>}
     */
  ...
  /**
     * @param params    {{balanceA: BigNumber, balanceB: BigNumber, seqnoA: BigNumber, seqnoB: BigNumber}}
  ...
  async signState(params) {
    ...
    const sentCoinsA = this.options.initBalanceA.gt(params.balanceA) ? this.options.initBalanceA.sub(params.balanceA) : new BigNumber(0);
    const sentCoinsB = this.options.initBalanceB.gt(params.balanceB) ? this.options.initBalanceB.sub(params.balanceB) : new BigNumber(0);
  ...
  /**
     * @returns {Promise<{state: number, balanceA: BigNumber, balanceB: BigNumber, publicKeyA: Uint8Array, publicKeyB: Uint8Array, channelId: BigNumber, quarantineDuration: number, misbehaviorFine: BigNumber, conditionalCloseDuration: number, seqnoA: BigNumber, seqnoB: BigNumber, quarantine: Cell, excessFee: BigNumber, addressA: Address, addressB: Address}>}
     */
  async getData() {
    /**
         * @param bn    {BigNumber}
  ...
  fromWallet(params) {
    ...
    const transfer = (payloadPromise, needStateInit) => {
      ...
      return {
        /**
                 * @param amount    {BigNumber}    in Toncoins
                 */
        send: (amount) => {
