...
class NftItem extends Contract {
    ...
    /**
     * @return {Promise<{isInitialized: boolean, index: number, itemIndex: BigNumber, collectionAddress: Address|null, ownerAddress: Address|null, contentCell: Cell, contentUri: string|null}>}
     */
    async getData() {
