...
import {Cell, Address, toNano} from "./toncore";
...
class DnsRoot extends Contract {
    constructor(provider) {
        const options = {};
        options.workChain = -1;
        options.code = options.code || Cell.fromBoc(Buffer.from('', 'hex'))[0];
    ...
    createDataCell() {
        ...
        cell.storeAddress(Address.parse('EQC3dNlesgVD8YbAazcauIrXBPfiVhMMr5YYk2in0Mtsz0Bz'));
        cell.storeAddress(Address.parse('EQCA14o1-VWhS2efqoh_9M1b_A9DtKTuoqfmkn83AbJzwnPi'));
        cell.storeAddress(Address.parse('EQB43-VCmf17O7YMd51fAvOjcMkCw46N_3JMCoegH_ZDo40e'));
        return cell.asCell();
    }
}
...
// const seed = Buffer.from('at58J2v6FaSuXFGcyGtqT5elpVxcZ+I1zgu/GUfA5uY=', 'base64'));
    ...
    const dnsCollection = new DnsCollection(tonweb.provider, {
        ...
        code: Cell.fromBoc(Buffer.from('', 'hex'))[0]
    });
    ...
    const deployDnsCollection = async () => {
        ...
        const payload = new Cell().asBuilder();
    ...
    const getDnsCollectionInfo = async () => {
        ...
        const cell = new Cell().asBuilder();
        cell.storeStringTail('alicealicealicealicealicealicealicealicealicealicealicealicealicealicealicealicealicealicealicealicealicealicealicealicealicea');
        const hash = cell.asCell().hash();
        const bn = new BN(hash.toString('hex'), 16);
    ...
    const dnsItemAddress = Address.parse('EQDEwJoXDBqBFI-0pvYJOuI5MEuvYthhwkl56qi5oclHMyGC');
    ...
    const setWalletRecord = async () => {
        ...
        console.log(
            await wallet.methods.transfer({
                ...
                amount: toNano('0.1'),
                seqno: seqno,
                payload: await TonWeb.dns.DnsItem.createChangeContentEntryBody({category: TonWeb.dns.DNS_CATEGORY_WALLET, value: TonWeb.dns.createSmartContractAddressRecord(Address.parse('EQA0i8-CdGnF_DhUHHf92R1ONH6sIA9vLZ_WLcCIhfBBXwtG'))}), // body
                sendMode: 3,
            }).send()
        );
    }
    ...
    const releaseDnsItem = async () => {
        ...
        body.storeUint(0x4ed14b65, 32);
        body.storeUint(123, 64);
        ...
        console.log(
            await wallet.methods.transfer({
                ...
                payload: await dnsItem.createTransferBody({
                    newOwnerAddress: Address.parse('EQBs7JfxnH2jNAlo0ytfKc77sSHQsUBzofngOkcLZyJlmm3j'),
