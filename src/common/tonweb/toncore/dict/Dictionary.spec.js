...
describe('Dictionary', () => {
    it('should parse and serialize dict from example', () => {
        ...
        // Empty
        let fromEmpty = Dictionary.empty();
    ...
    it('should generate merkle proofs', () => {
        ...
        for (let k = 1; k <= 5; k++) {
            ...
            expect(exoticMerkleProof(proof.bits, proof.refs).proofHash).toEqual(Buffer.from('ee41b86bd71f8224ebd01848b4daf4cd46d3bfb3e119d8b865ce7c2802511de3', 'hex'));
        }
    });
    it('should generate merkle updates', () => {
        ...
        for (let k = 1; k <= 5; k++) {
            ...
            expect(exoticMerkleUpdate(update.bits, update.refs).proofHash1).toEqual(Buffer.from('ee41b86bd71f8224ebd01848b4daf4cd46d3bfb3e119d8b865ce7c2802511de3', 'hex'));
